...
class HeightmapType:
    ...
    sampling: Samples per heightmap datum. For rasterized heightmaps,
        ...
        higher value, e.g. 2, will generally improve the quality of the
        heightmap but lower performance.
    """
    class Meta:
        name = "heightmapType"
    ...
    class Texture:
        ...
        The order of the texture matters. The first texture will appear
        at the lowest height, and the last texture at the highest
        height. Use blend to control the height thresholds and fade
        between textures.
