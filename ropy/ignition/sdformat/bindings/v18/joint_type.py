...
class JointType:
    ...
    class Axis:
        ...
        Parameters
        ----------
        initial_position: (DEPRECATION WARNING: This tag has no known
            implementation. It is deprecated SDFormat 1.8 and will be
            removed in SDFormat 1.9) Default joint position for this
            joint axis.
        xyz: Represents the x,y,z components of the axis unit vector.
            The axis is expressed in the joint frame unless a different
            frame is expressed in the expressed_in attribute. The vector
